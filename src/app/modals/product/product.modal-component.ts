...
import { Customer, Product, ProductResource } from "../../types";
...
@Component({
    ...
    imports: [PageModule, CardModule, FormFieldModule, InputComponent, Field, FormsModule, ModalFooterComponent, ButtonComponent, LoadingOverlayComponent, FlagComponent]
})
export class ProductModalComponent {
    ...
    async #submit(): Promise<void> {
        ...
        await this.#productService.createProduct(this.#form().value(), this.#props.settings)
