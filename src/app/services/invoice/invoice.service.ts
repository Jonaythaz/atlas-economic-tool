...
function toNewInvoice(
	...
	return {
		...
		customer,
		date: invoice.date,
		recipientEan: invoice.customer.ean,
		recipientName: invoice.customer.name,
		recipientStreet: invoice.customer.street,
		recipientCity: invoice.customer.city,
		recipientPostalCode: invoice.customer.postalCode,
		recipientCountry: invoice.customer.country,
