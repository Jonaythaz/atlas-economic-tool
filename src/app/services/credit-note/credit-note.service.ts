...
function toNewInvoice(
	...
	return {
		...
		recipientEan: creditNote.customer.ean,
		recipientName: creditNote.customer.name,
		recipientStreet: creditNote.customer.street,
		recipientCity: creditNote.customer.city,
		recipientPostalCode: creditNote.customer.postalCode,
		recipientCountry: creditNote.customer.country,
